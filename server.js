...
const { Client, PrivateKey } = require('@hiveio/dhive'); // NEW: Hive Library

const app = express();
app.use(cors());

// --- HIVE CONFIGURATION ---
// Use environment variables for security (process.env.HIVE_ACTIVE_KEY)
